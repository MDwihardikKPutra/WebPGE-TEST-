        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            {projects.map((project, index) => (
              <div
                key={index}
                className="scroll-animate" /* Tambah scroll-animate */
          ...
          <div className="text-center scroll-animate">
            {" "}
            {/* Tambah scroll-animate */}
            <button className="bg-gradient-to-r from-primary-red to-primary-red/80 hover:from-primary-red/90 hover:to-primary-red/70 text-app-white px-10 py-4 rounded-xl font-bold transition-all duration-300 hover:scale-105 hover:shadow-2xl">
              View More Projects
            </button>
          </div>
        </div>
