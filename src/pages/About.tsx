...
function About() {
  // Effect untuk animasi scroll, bisa dipindahkan ke sini jika spesifik untuk halaman ini
  // atau biarkan di App.tsx jika itu untuk semua halaman
  useEffect(() => {
  ...
  const partners = ["/img/iso-1.png", "/img/iso-2.png", "/img/iso-3.png"];
    ...
    <div className="pt-20">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-on-scroll opacity-0 translate-y-8 transition-all duration-800">
      ...
      <section className="py-24 bg-app-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row justify-between items-center mb-16 animate-on-scroll opacity-0 translate-y-8 transition-all duration-800">
            <div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {partners.map((partner, index) => (
              <div
                key={index}
                className="animate-on-scroll opacity-0 translate-y-8 transition-all duration-800 group"
...
export default About; // PENTING: Pastikan ini diekspor sebagai default!
